...
SECONDARY_FFT_LEN_LOG2 = 8

#4us, 100us: SECONDARY_FFT_LEN_LOG2 = 9
#52us: SECONDARY_FFT_LEN_LOG2 = 11
SECONDARY_FFT_MAX_LEN_LOG2 = 9
...
# AH100 (NUM_DECODE_PATHWAYS>1): 6
# Butterfly (NUM_DECODE_PATHWAYS=1): 7
MAX_CHIPS_PER_SYMBOL_LOG2 = 6
...
# AH100: 3
# Butterfly: 1
NUM_DECODE_PATHWAYS = 3

NUM_MUX_CHANNELS = NUM_DECODE_PATHWAYS+2
PN_SEQ_LEN = 15
ESAMP_WIDTH = 20
CORR_WIDTH = 32
FFT_SHIFT_WIDTH = 6
...
CORR_METADATA_WIDTH = CORR_WIDTH*2+CORR_MANTISSA_WIDTH+1
SFO_FRAC_WIDTH = 16
SFO_INT_WIDTH = 16
SFO_SEQ_LEN = 72
...
NUM_MUX_CHANNELS_LOG2 = int(np.ceil(np.log2(NUM_MUX_CHANNELS+1)))
NUM_METADATA_LOG2 = int(np.ceil(np.log2(NUM_METADATA+1)))
MAX_NUM_HARMONICS_LOG2 = int(np.ceil(np.log2(MAX_NUM_HARMONICS+1)))
...
with open('mrr_params.vh','w') as f:
    ...
    f.write('localparam NUM_MUX_CHANNELS = {};\n'.format(NUM_MUX_CHANNELS))
    f.write('localparam NUM_MUX_CHANNELS_LOG2 = {};\n'.format(NUM_MUX_CHANNELS_LOG2))
    ...
    f.write('localparam MAX_NUM_HARMONICS = {};\n'.format(MAX_NUM_HARMONICS))
    f.write('localparam MAX_NUM_HARMONICS_LOG2 = {};\n'.format(MAX_NUM_HARMONICS_LOG2))
